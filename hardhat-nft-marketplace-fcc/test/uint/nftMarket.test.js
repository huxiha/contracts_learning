...
describe("Nft Marketplace Unit Tests", function () {
  ...
  beforeEach(async () => {
    ...
    nftMarketplaceContract = await ethers.getContract("NftMarket");
  ...
  describe("listItem", function () {
    ...
    it("needs approvals to list item", async function () {
      ...
      await expect(
        nftMarketplace.listItem(basicNft.address, TOKEN_ID, PRICE)
      ).to.be.revertedWith("NftMarket__NotApprovedForMarket");
    });
    ...
    it("reverts if the price be 0", async () => {
      ...
      ).revertedWith("NftMarket__PriceMustAboveZero");
    });
  });
  ...
  describe("buyItem", function () {
    ...
    it("reverts if the price isnt met", async function () {
      ...
      await expect(
        nftMarketplace.buyItem(basicNft.address, TOKEN_ID)
      ).to.be.revertedWith("NftMarket__PriceNotMeet");
    });
  ...
  describe("updateListing", function () {
    ...
    it("reverts if new price is 0", async function () {
      ...
      ).to.be.revertedWith("NftMarket__PriceMustAboveZero");
    });
